...
def generate_triples(
    ...
    for processing_idx, qid in enumerate(qid2rankings):
        l = sample_for_query(qid, qid2rankings[qid], positives, depth_positive, depth_negative, cutoff_negative)
...
#
#     generate_triples(args.ranking, args.output, args.positives, args.depth_positive, args.depth_negative, args.cutoff_negative)
